...
Listing 2 shows a trivial example for the \texttt{open} call. However, it may be the case that this approach only covers some subset of the calls to be tested, and manual work is still required. Issues such as variadic functions and custom \texttt{typedef}s in the method signature will have to be dealt with. However, this preliminary work suggests that this technique may have potential to reduce the amount of manual work required.
